...
public class AdminMainScreen extends javax.swing.JPanel {
    ...
    public void populate(){
        DefaultTableModel dtm_sup = (DefaultTableModel)tableSup.getModel();
        DefaultTableModel dtm_cus = (DefaultTableModel)tableCust.getModel();
        dtm_sup.setRowCount(0);
        for(User u : admin.getSuppDir().getSupplierList()){
            Supplier s = (Supplier)u;
            Object[] row = new Object[dtm_sup.getColumnCount()];
            row[0]=s;
        ...
        for(User u : admin.getCustDir().getCustomerList()){
            ...
            Object[] row = new Object[dtm_cus.getColumnCount()];
            row[0]=s;
            row[1]=s.getDate();
            dtm_cus.addRow(row);
        }
